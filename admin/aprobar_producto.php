...
// Actualizar estado
$stmt = $pdo->prepare("UPDATE productos SET estado = 'activo' WHERE id = ?");
...
if ($datos) {
    $template = file_get_contents('../includes/plantillas/producto_aprobado.html');
    $mensaje = str_replace(
    ...
    enviarCorreo($datos['correo'], '✅ Tu producto ha sido aprobado', $mensaje);
}
